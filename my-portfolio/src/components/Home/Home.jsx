          ...
          <div className="row align-items-center">
            <div className="col-md-8 col-sm-12 mx-auto text-center text-md-start">
              ...
              <p className="fs-4 mt-3">
                I am a front-end web developer with a bioengineering background.
                My passion for technology and creativity drives me to design and
                develop unique websites. Combining my technical skills and
                innovative mindset, I strive to create visually appealing web
                pages.
              </p>
              <a
                href="https://cemileblks.github.io/react-portfolio/projects"
                className="btn button-pink mt-3 fs-5"
                rel="noopener noreferrer"
              >
                View Projects
              </a>
              <a
                href="https://cemileblks.github.io/react-portfolio/contact"
                className="btn button-pink mt-3 fs-5 mx-3"
                rel="noopener noreferrer"
              >
                Contact me
              </a>
